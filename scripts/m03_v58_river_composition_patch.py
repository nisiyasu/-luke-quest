...
"const waterLower=createTargetWaterV3({width:7.2,depth:17.5,seed:317});waterLower.position.set(-1.35,.04,8.8);scene.add(waterLower);":"const waterLower=createTargetWaterV3({width:9.6,depth:17.5,seed:317});waterLower.position.set(-3.55,.04,8.8);scene.add(waterLower);"
}
