...
/* LUKE QUEST v0.122 situational victory banter.
...
const startBattleV121=startBattle;startBattle=function(){resetMeta();return startBattleV121();};
const attackV121=attack;attack=function(){if(s.screen==='battle'){s.lqBattleMeta=s.lqBattleMeta||{};s.lqBattleMeta.turns=(s.lqBattleMeta.turns||0)+1;}return attackV121();};
const guardV121=guard;guard=function(){if(s.screen==='battle'){s.lqBattleMeta=s.lqBattleMeta||{};s.lqBattleMeta.turns=(s.lqBattleMeta.turns||0)+1;}return guardV121();};
const potionV121=potion;potion=function(){if(s.screen==='battle'){s.lqBattleMeta=s.lqBattleMeta||{};s.lqBattleMeta.turns=(s.lqBattleMeta.turns||0)+1;s.lqBattleMeta.herbUsed=true;}return potionV121();};
if(window.lqFocusSlash){const skillV121=window.lqFocusSlash;window.lqFocusSlash=function(){if(s.screen==='battle'){s.lqBattleMeta=s.lqBattleMeta||{};s.lqBattleMeta.turns=(s.lqBattleMeta.turns||0)+1;}return skillV121();};}
...
const winV121=win;win=function(){const meta={...(s.lqBattleMeta||{})},ratio=s.hp/Math.max(1,s.mh);const r=winV121();if(s.dialog?.name==='ルーク'&&Math.random()<.7){const line=contextual(meta,ratio);if(line){s.dialog.text=line;s.recentVictoryLines=Array.isArray(s.recentVictoryLines)?s.recentVictoryLines:[];s.recentVictoryLines.push(line);s.recentVictoryLines=s.recentVictoryLines.slice(-8);save();render();}}return r;};
window.LQ_VICTORY_LINE_COUNT=Math.max(Number(window.LQ_VICTORY_LINE_COUNT)||60,90);window.LQ_SITUATIONAL_BANTER_STATUS={close:10,herb:10,quick:10,last8Protection:true};
})();