...
.lqAldiaWindow{position:absolute;z-index:5;pointer-events:none;width:24px;height:22px;border:3px solid #4f4537;border-radius:3px;background:linear-gradient(135deg,#e8f7ee 0 18%,#b8e3df 19% 38%,#5f8d9d 62%,#355363);box-shadow:inset 0 0 0 2px #fff2c788,0 3px 4px #0005,0 0 8px #bce9d844}
