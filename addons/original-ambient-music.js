...
function schedulePhrase(token){
  ...
  if(theme==='safe'){
    // Original gentle suspended-chord fragment: deliberately short/non-songlike.
    ...
    // Original sparse exploration pulse with different interval contour.
...
if(renderBeforeMusic){
  render=function(){const r=renderBeforeMusic();ensureButton();return r;};
}
