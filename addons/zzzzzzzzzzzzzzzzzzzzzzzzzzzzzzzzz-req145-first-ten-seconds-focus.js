...
body.lqReq145GoldSlice[data-lq145-screen="world"] .world{
...
body.lqReq145GoldSlice[data-lq145-screen="world"] .gameShell::before{
  background:linear-gradient(180deg,rgba(0,0,0,.22),transparent 19%,transparent 70%,rgba(0,0,0,.38)),radial-gradient(circle at 50% 43%,transparent 40%,rgba(0,0,0,.25) 100%)!important;
}
...
@media(prefers-reduced-motion:reduce){
  body.lqReq145GoldSlice[data-lq145-screen="world"] .world{filter:saturate(1.06) contrast(1.035)}
}
`;
