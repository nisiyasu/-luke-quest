...
const OUTDOOR=new Set(['town','field','forest','deepForest','mistTrail','observation','evacuation','evacRoute','cliff','cliffRoad','northCliffRoad','windcutPass','northRidgeApproach']);
...
function cloudClass(map=s.map){if(['forest','deepForest'].includes(map))return'forest';if(['mistTrail','cliff','cliffRoad','northCliffRoad','windcutPass','northRidgeApproach'].includes(map))return'mist';if(['observation','evacuation','evacRoute'].includes(map))return'hostile';return'';}
function addClouds(){
