...
function kindFor(map=s.map){if(['forest','deepForest'].includes(map))return'leaf';if(['mistTrail','evacuation','evacRoute','cliff','cliffRoad','northCliffRoad','windcutPass','northRidgeApproach','windShelf','skylineTraverse','cloudbreakSaddle'].includes(map))return'mist';if(map==='observation')return'ash';return'dust';}
function stepFx(){
