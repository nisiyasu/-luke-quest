...
function facingBoundary(){if(typeof front!=='function'||!MAPS?.[WIND])return false;const [fx,fy]=front();const n=MAPS[WIND].npcs?.find(v=>v.x===fx&&v.y===fy);return n?.kind===BOUNDARY_KIND;}
