...
const TYPE={town:'motes',field:'motes',forest:'leaves',deepForest:'leaves',mistTrail:'fog',observation:'embers',evacRoute:'fog',cliffRoad:'fog',northCliffRoad:'fog',windcutPass:'fog',northRidgeApproach:'fog',windShelf:'fog',skylineTraverse:'fog'};
let lastMap=null;
function build(){
