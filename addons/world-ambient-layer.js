...
const TYPE={town:'motes',field:'motes',forest:'leaves',deepForest:'leaves',mistTrail:'fog',observation:'embers',evacRoute:'fog',cliffRoad:'fog',northCliffRoad:'fog',windcutPass:'fog',northRidgeApproach:'fog',windShelf:'fog',skylineTraverse:'fog',cloudbreakSaddle:'fog',windStairRidge:'fog'};
let lastMap=null;
function build(){
...
window.LQ_WORLD_AMBIENT_STATUS={regional:true,nonInteractive:true,reducedMotion:true,hasMap:(map)=>Object.prototype.hasOwnProperty.call(TYPE,map),typeFor:(map)=>TYPE[map]||null,windStairRidgeIntegrated:true};
build();
})();
