...
const TYPE={town:'motes',field:'motes',forest:'leaves',deepForest:'leaves',mistTrail:'fog',observation:'embers',evacRoute:'fog',cliffRoad:'fog'};
let lastMap=null;
function build(){
...
window.LQ_WORLD_AMBIENT_STATUS={regional:true,nonInteractive:true,reducedMotion:true};
build();
})();
