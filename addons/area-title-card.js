...
const SUB={
 town:'王国南部の城郭都市',field:'王都と魔物の森を結ぶ街道',forest:'レオンを追う最初の森',deepForest:'森の気配が濃くなる深部',mistTrail:'足跡が霧へ消える追跡路',observation:'魔王軍が何かを監視している区域',evacuation:'北へ延びる古い退避路',evacRoute:'北へ延びる古い退避路',cliff:'風の強い北方崖道',cliffRoad:'風の強い北方崖道',northCliffRoad:'退避路の先へ続く風の強い北方崖道',windcutPass:'北尾根へ続く風の強い高所峠',
