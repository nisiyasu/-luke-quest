...
const SUB={
 town:'王国南部の城郭都市',field:'王都と魔物の森を結ぶ街道',forest:'レオンを追う最初の森',deepForest:'森の気配が濃くなる深部',mistTrail:'足跡が霧へ消える追跡路',observation:'魔王軍が何かを監視している区域',evacRoute:'北へ延びる古い退避路',cliffRoad:'風の強い北方崖道',innInside:'南門宿の客間',shopInside:'ミナの道具屋',templeInside:'王国神殿',residenceInside:'王都の民家'
};
...
window.LQ_AREA_TITLE_STATUS={cinematic:true,mapAware:true,reducedMotion:true};
showTitle();
})();
