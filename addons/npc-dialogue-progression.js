...
const DIALOGUE_STATES={
 '旅好きの老人':[
  ...
  'おかえり。まずは帰ってこられた、それで十分だ。今日は答え探しより、ちゃんと休め。'
 ],
 '道具屋のミナ':[
  ...
  'おかえりなさい。全員戻れたなら、今日は薬草より温かいご飯の方が効きそうですね。'
 ],
 '神殿の見習い':[
  ...
  '無事に戻ったんですね。記録は後で大丈夫です。今はみんなが休めることの方が大事です。'
 ],
 '畑仕事の青年':[
  ...
  '戻ったか。よし、今日は北も森もなしだ。腹いっぱい食ってから考えればいい。'
 ]
};

function progressionStage(){
 const f=s.flags||{};
 if(f.chapter1Complete===true)return 6;
...
window.LQ_NPC_DIALOGUE_PROGRESSION_STATUS={stage:'canonical-state-reactive-npc-dialogue',npcCount:Object.keys(DIALOGUE_STATES).length,stateCount:7,maps:['town','field'],canonicalFlags:['wins','leonSeen','mistEntered','glennTraceSeen','observationEntered','glennSeen','evacEntered','withdrawProofSeen','chapter1Complete'],currentStage:initialStage,projectionOnly:true,changesNpcPosition:false,changesCollision:false,chapter1CompleteAware:true};
})();
