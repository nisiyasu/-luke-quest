...
/* LUKE QUEST v0.125 recent dialogue log.
   Keeps recent conversations accessible from the adventure menu for story readability. */
...
const renderV124=render;render=function(){captureDialog();const r=renderV124();addLog();return r;};const worldV124=world;world=function(){worldV124();addLog();};window.LQ_DIALOGUE_LOG_STATUS={maxSaved:30,menuVisible:8};save();captureDialog();addLog();
})();