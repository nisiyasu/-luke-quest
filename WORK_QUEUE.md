...
| 81 | REQ-082 | P1 | IN_PROGRESS | 北の崖道・通常エンカウント統合 | `requirements/REQ-082_NORTH_CLIFF_ENCOUNTER_INTEGRATION.md` | REQ-081の本線地域を既存canonical random encounterへ接続。新敵は作らずEVAC_ENEMIESを再利用し、entry/return graceを付与。既存戦闘・敵art・touch/fullscreenを壊さず検証中。 |
