...
| 46 | REQ-046 | P1 | VERIFY | Defeat Enemy-State Cleanup | `requirements/REQ-046_DEFEAT_ENEMY_STATE_CLEANUP.md` | canonical defeat後world saveに残るstale enemy/ehpをbattle→town recovery後にnull/0へ正規化。Pages run 34010304447 SUCCESS。IOS_PHYSICAL_VERIFICATION=PENDING |
