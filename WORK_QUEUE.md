...
| 3 | REQ-021 | P0 | IN_PROGRESS | 画面のどこを短くタップしてもAアクション | `requirements/REQ-021_TAP_ANYWHERE_ACTION.md` | Owner BOOT v3 absolute P0-1 re-audit。fresh HEADでpublic inclusionを再確認済み。新規generic NPC DOM layerも含むexact-head P0 Touch再実行を開始。IOS_PHYSICAL_VERIFICATION=PENDING。 |
...
| 127 | REQ-145 | P0 | READY | Gold Vertical Slice Continuous Quality Lane | `requirements/REQ-145_GOLD_VERTICAL_SLICE_CONTINUOUS_QUALITY_LANE.md` | Owner BOOT v3 absolute P0 input re-audit temporarily preempts challenger lane. Branch/history preserved; resume after REQ-021 -> REQ-022 -> REQ-001 machine/public re-audit. |
