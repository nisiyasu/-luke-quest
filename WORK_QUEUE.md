...
| 75 | REQ-075 | P1 | VERIFY | Optional Boss Objective Chip Tracking | `requirements/REQ-075_OPTIONAL_OBJECTIVE_CHIP_TRACKING.md` | 巨大蹄跡を発見後だけworld SIDE chipへ再調査導線を表示。撃破後は消える。既存3 optional objective precedence保持、Pages run 34019286555 SUCCESS。IOS_PHYSICAL_VERIFICATION=PENDING |
