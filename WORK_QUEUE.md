...
|---:|---|---|---|---|---|---|
| -2 | REQ-127 | P0 | VERIFY | iPhone Black Screen Autonomous Detection & Recovery | `requirements/REQ-127_IPHONE_PWA_PERSISTENT_BLACK_SCREEN_RECOVERY.md` | Machine recovery complete: Chromium + Safari-family WebKit 390x844 world-state/pixel liveness PASS, standard Pages SUCCESS, cache-busted recovery deployment SUCCESS, one-shot PWA stale-document navigation deployed. IOS_PHYSICAL_VERIFICATION=PENDING; do not claim device PASS until Owner confirms. |
...
| 112 | REQ-130 | P1 | IN_PROGRESS | Chapter 1 Adventure Record Completion | `requirements/REQ-130_CHAPTER_01_ADVENTURE_RECORD_COMPLETION.md` | No READY remained after REQ-129. Directive-authorized player-visible completion projection: reuse canonical chapter1Complete in ADVENTURE RECORD without inventing Chapter 2. Implementation ffa72c14...; dedicated gate/public Pages pending. IOS_PHYSICAL_VERIFICATION=PENDING. |
