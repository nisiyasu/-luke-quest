...
| 7 | REQ-007 | P1 | IN_PROGRESS | 地域別戦闘背景画像の正式化 | `requirements/REQ-007_ORIGINAL_BATTLE_BACKGROUNDS.md` | 6通常遭遇地域へオリジナル地域別battle backdrop image layerを実装中。CSS-only背景を最終品質扱いしない |
