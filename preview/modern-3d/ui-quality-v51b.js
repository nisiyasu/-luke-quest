...
@media (max-height:480px){#status{width:136px;padding:6px 8px}.hud-hp-row{margin-top:4px}.objective{width:136px;padding:6px 8px}.objective-arrow{width:25px;height:25px;font-size:13px}#route-cue,#location-ribbon{display:none}.action-orb{width:48px;height:48px}.action-orb strong{font-size:19px}.menu-orb{width:42px;height:42px;font-size:7px}}
