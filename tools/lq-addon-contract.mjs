...
const contracts=[
 ['render function','function render()'],['world renderer','function world()'],['battle renderer','function battle()'],['save function','function save()'],['current NPC helper','function currentNpcs()'],['front helper','function front()'],['main map registry','const MAPS='],['state object','const s=']
];
