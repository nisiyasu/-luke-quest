...
function installOwnerRegateHud(){
  ...
  // Previous v53 duplicated current/destination information in a large route card.
  // Remove it so the world remains the primary visual surface.
...
@media (max-width:380px){#status{width:138px}.objective{width:143px}.objective b{font-size:8px}.hero-sigil{width:23px;height:23px}.action-orb{width:54px;height:54px}.menu-orb{width:45px;height:45px}}
@media (max-height:480px){#status{width:132px;padding:5px 7px}.hud-hp-row{margin-top:4px}.objective{width:132px;padding:5px 7px}.objective-arrow{width:24px;height:24px;font-size:13px}#location-ribbon{display:none}.action-orb{width:46px;height:46px}.action-orb strong{font-size:18px}.menu-orb{width:40px;height:40px;font-size:7px}}
