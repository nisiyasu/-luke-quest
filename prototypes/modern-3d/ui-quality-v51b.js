...
@media (max-height:480px){#status{width:136px;padding:6px 8px}.objective{box-sizing:border-box!important;right:max(10px,env(safe-area-inset-right))!important;left:auto!important;width:142px!important;padding:6px 7px;gap:6px}.objective>div{overflow:visible;min-width:0}.objective b{font-size:8px;letter-spacing:0;white-space:nowrap}.objective small{font-size:6px;letter-spacing:.10em}.objective-arrow{width:23px;height:23px;font-size:12px}#route-cue,#location-ribbon{display:none}.action-orb{width:48px;height:48px}.action-orb strong{font-size:19px}.menu-orb{width:42px;height:42px;font-size:7px}}
