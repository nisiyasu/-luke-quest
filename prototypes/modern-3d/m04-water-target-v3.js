...
export function createTargetWaterV3({width=28,depth=6.2,seed=11,quality='auto'}={}){
  ...
  const uniforms={
    uTime:{value:0},
    uDeep:{value:new THREE.Color(0x064b76)},
    uMid:{value:new THREE.Color(0x087fa4)},
    uShallow:{value:new THREE.Color(0x54c4c0)},
    uSky:{value:new THREE.Color(0x9cb9c4)},
    uSun:{value:new THREE.Color(0xffe0a6)},
    uSunDir:{value:new THREE.Vector3(-.34,.88,.31).normalize()},
    uReflectionStrength:{value:practical?.18:.34},
    uSparkleStrength:{value:practical?.29:.56},
    uWaveStrength:{value:practical?.68:.94},
    uCausticStrength:{value:practical?.11:.19},
    uFoamStrength:{value:practical?.46:.73},
