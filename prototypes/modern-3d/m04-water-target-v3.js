...
export function createTargetWaterV3({width=28,depth=6.2,seed=11,quality='auto'}={}){
  ...
  const uniforms={
    uTime:{value:0},
    uDeep:{value:new THREE.Color(0x07547c)},
    uMid:{value:new THREE.Color(0x168eb8)},
    uShallow:{value:new THREE.Color(0x78d8d2)},
    ...
    uDepthContrast:{value:practical?1.04:1.18},
