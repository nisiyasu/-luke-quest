...
export function createTargetWaterV3({width=28,depth=6.2,seed=11,quality='auto'}={}){
  ...
  g.userData={assetId:'water_target_v3',version:'3.6.0',stage:'M07_IN_PROGRESS',source:'repo-procedural',qualityPreset:resolvedQuality,reflectionMethod:'single-pass analytic wave-normal Fresnel sky reflection + directional sun specular; no planar RTT/SSR',performanceIntent:practical?'52x20 surface grid, reduced sparkles/shore foam, fewer rocks, no rock cast shadows':'96x40 surface grid, denser sparkles/shore foam, full shoreline rock shadows',intent:'depth-banded turquoise river with restrained moving wave reflection, shoreline transition, foam and grounded rocks; avoids flat blue plate and excessive emissive glow',update:t=>uniforms.uTime.value=t};
  return g;
}
