...
export function createTargetWaterV3({width=28,depth=6.2,seed=11,quality='auto'}={}){
  ...
  g.userData={assetId:'water_target_v3',version:'3.12.0',stage:'M04_REGATE',source:'repo-procedural',qualityPreset:resolvedQuality,reflectionMethod:'single-pass analytic wave-normal Fresnel sky reflection + directional sun specular; no planar RTT/SSR',performanceIntent:practical?'52x20 surface grid, reduced sparkle/caustic/shore foam, fewer rocks, no rock cast shadows':'96x40 surface grid, denser sparkle/caustic/shore foam, full shoreline rock shadows',resourceBudget:{surfaceSegments:[segmentsX,segmentsY],sparkleCount:sparkCount,rockCount,rockCastShadows:!practical,reflectionStrength:uniforms.uReflectionStrength.value,waveStrength:uniforms.uWaveStrength.value,causticStrength:uniforms.uCausticStrength.value,foamStrength:uniforms.uFoamStrength.value},intent:'luminous target-derived river with deterministic irregular clipping on both bank sides and longitudinal end caps, readable turquoise shallows, whitewater/sparkle cues and preserved depth; removes hard rectangular pool/river endpoints visible in integrated HQ evidence without changing traversal authority',update:t=>uniforms.uTime.value=t};
  return g;
}
